...
class BETRLoss(nn.Module):
    ...
    def forward(self, preds, batch):
        ...
        gt_offset_map = batch['gt_offsets_3d'].view(-1, 16, 1, 1).expand(-1, -1, self.heatmap_size, self.heatmap_size)  # [B, 16, 128, 128]
        loss_offset = self._weighted_loss(preds['bb8 offsets'], gt_offset_map, weight_map)
